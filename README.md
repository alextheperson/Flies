...
## How It Works
![A flowchart depicting the steps the simulation does each cycle.](images/EA%20Flow.png)
...
![A diagram depicting the mixture of two parent's DNA and some mutation to create the DNA of the child.](images/EA%20Breeding.png)
